...
# Manually open Update Manager, choose a policy, upgrade the kernel and restart
continue_quit "Manually open Update Manager, choose a policy, upgrade the kernel and restart"
if [ $response == "q" ]
then
    echo "Exiting..."
    exit 1
